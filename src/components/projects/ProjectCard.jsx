...
const ProjectCard = ({title, des, src}) => {
  return (
    <div className='w-full p-4 xl:px-12 h-auto xl:py-10 rounded-lg shadow-shadowOne flex flex-col group hover:bg-gradient-to-b hover:from-gray-500 translation-colors duration-1000'>
