...
const Education = () => {
  return (
    <motion.div initial={{opacity:0}} animate={{opacity:1, transition:{duration: 0.5}}} className='w-full flex-col lgl:flex-row gap-10 lgl:gap-20'>
        {/* part one */}
    <div>
        <div className='py-6 lgl:py-12 font-titleFont flex flex-col gap-4'>
            {/* <p className='text-sm text-designColor tracking-[4px]'>1998 - 2010</p> */}
            <h2 className='text-3xl md:text-4xl font-bold'>Educational Quality</h2>
        </div>
